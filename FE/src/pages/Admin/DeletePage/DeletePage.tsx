      ...
      <div className="w-full h-full relative">
        ...
        <div className="w-[400px] bg-white rounded-lg absolute top-1/4 left-1/2 -translate-x-1/2 p-4 pb-10">
          ...
          <div className="flex justify-between items-center">
            <button className="w-[45%] h-12 border border-solid border-gray-300 bg-gray-300 rounded-xl font-semibold hover:bg-gray-400" onClick={() => handleDelete(id)}>Delete</button>
            <button className="w-[45%] h-12 border border-solid border-gray-300 rounded-xl font-semibold hover:bg-gray-400" onClick={() => handleCancel()}>Cancel</button>
          </div>
        </div>
      </div>
    </div>
